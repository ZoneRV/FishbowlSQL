...
--
-- Table structure for table `plugininfo_aud`
--

DROP TABLE IF EXISTS `plugininfo_aud`;
...
CREATE TABLE `plugininfo_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKb72469tuj9vwgibnfkxh33xjw` (`REV`),
  CONSTRAINT `FKb72469tuj9vwgibnfkxh33xjw` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
