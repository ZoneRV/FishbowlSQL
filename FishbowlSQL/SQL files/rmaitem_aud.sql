...
--
-- Table structure for table `rmaitem_aud`
--

DROP TABLE IF EXISTS `rmaitem_aud`;
...
CREATE TABLE `rmaitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKm71h1f94jx8hq7j9su5hva9sw` (`REV`),
  CONSTRAINT `FKm71h1f94jx8hq7j9su5hva9sw` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
