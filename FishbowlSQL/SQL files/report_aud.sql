...
--
-- Table structure for table `report_aud`
--

DROP TABLE IF EXISTS `report_aud`;
...
CREATE TABLE `report_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK9jco7b1dh8fntwnvsxgxtoisx` (`REV`),
  CONSTRAINT `FK9jco7b1dh8fntwnvsxgxtoisx` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
