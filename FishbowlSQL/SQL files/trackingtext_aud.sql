...
--
-- Table structure for table `trackingtext_aud`
--

DROP TABLE IF EXISTS `trackingtext_aud`;
...
CREATE TABLE `trackingtext_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKa14p8t82bdsmpwxpu79teocxg` (`REV`),
  CONSTRAINT `FKa14p8t82bdsmpwxpu79teocxg` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
