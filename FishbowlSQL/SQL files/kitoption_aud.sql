...
--
-- Table structure for table `kitoption_aud`
--

DROP TABLE IF EXISTS `kitoption_aud`;
...
CREATE TABLE `kitoption_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKbdmobuo6xq72spfg7784iai46` (`REV`),
  CONSTRAINT `FKbdmobuo6xq72spfg7784iai46` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
