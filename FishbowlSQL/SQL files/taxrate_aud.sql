...
--
-- Table structure for table `taxrate_aud`
--

DROP TABLE IF EXISTS `taxrate_aud`;
...
CREATE TABLE `taxrate_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKg0xxq3cq3ciiue1tacqcdu180` (`REV`),
  CONSTRAINT `FKg0xxq3cq3ciiue1tacqcdu180` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
