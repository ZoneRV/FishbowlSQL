...
--
-- Table structure for table `shippingimport`
--

DROP TABLE IF EXISTS `shippingimport`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shippingimport` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cartonCost` double DEFAULT NULL,
  `cartonVoid` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT 'N',
  `cartonWeight` decimal(28,9) DEFAULT NULL,
  `ignoreThis` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipCartonId` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
