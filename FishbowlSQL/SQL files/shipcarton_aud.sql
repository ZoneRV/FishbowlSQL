...
--
-- Table structure for table `shipcarton_aud`
--

DROP TABLE IF EXISTS `shipcarton_aud`;
...
CREATE TABLE `shipcarton_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKfgcy1niav3yjnjvfspk73wopt` (`REV`),
  CONSTRAINT `FKfgcy1niav3yjnjvfspk73wopt` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
