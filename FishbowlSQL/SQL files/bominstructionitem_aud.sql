...
--
-- Table structure for table `bominstructionitem_aud`
--

DROP TABLE IF EXISTS `bominstructionitem_aud`;
...
CREATE TABLE `bominstructionitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK1vo0pg9iigivovt1gse06bjv` (`REV`),
  CONSTRAINT `FK1vo0pg9iigivovt1gse06bjv` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
