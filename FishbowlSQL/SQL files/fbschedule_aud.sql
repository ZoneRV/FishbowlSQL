...
--
-- Table structure for table `fbschedule_aud`
--

DROP TABLE IF EXISTS `fbschedule_aud`;
...
CREATE TABLE `fbschedule_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK74r6lkxkr857a0xsk1q1hhja6` (`REV`),
  CONSTRAINT `FK74r6lkxkr857a0xsk1q1hhja6` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
