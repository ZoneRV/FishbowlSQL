...
--
-- Table structure for table `parttracking_aud`
--

DROP TABLE IF EXISTS `parttracking_aud`;
...
CREATE TABLE `parttracking_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKiun52c7xy2ckiu248ju0by7ce` (`REV`),
  CONSTRAINT `FKiun52c7xy2ckiu248ju0by7ce` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
