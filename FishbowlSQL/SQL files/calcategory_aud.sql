...
--
-- Table structure for table `calcategory_aud`
--

DROP TABLE IF EXISTS `calcategory_aud`;
...
CREATE TABLE `calcategory_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKoeogoj31jwsrf4r5ienx4ujk1` (`REV`),
  CONSTRAINT `FKoeogoj31jwsrf4r5ienx4ujk1` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
