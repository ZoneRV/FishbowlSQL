...
--
-- Table structure for table `postpo`
--

DROP TABLE IF EXISTS `postpo`;
...
CREATE TABLE `postpo` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKflcgqogakpdiphosae64nie5d` (`poId`),
  KEY `FKnx43y0atronpnmy1t5aabpacb` (`statusId`),
  CONSTRAINT `FKflcgqogakpdiphosae64nie5d` FOREIGN KEY (`poId`) REFERENCES `po` (`id`),
  CONSTRAINT `FKnx43y0atronpnmy1t5aabpacb` FOREIGN KEY (`statusId`) REFERENCES `postorderstatus` (`id`)
