...
--
-- Table structure for table `itemadjust_aud`
--

DROP TABLE IF EXISTS `itemadjust_aud`;
...
CREATE TABLE `itemadjust_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKqc2bi5ysdtly3lc6p5o70f9ii` (`REV`),
  CONSTRAINT `FKqc2bi5ysdtly3lc6p5o70f9ii` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
