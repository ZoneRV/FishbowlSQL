...
--
-- Table structure for table `receipt_aud`
--

DROP TABLE IF EXISTS `receipt_aud`;
...
CREATE TABLE `receipt_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKc2liwj75wuhhydftax1gmwp4o` (`REV`),
  CONSTRAINT `FKc2liwj75wuhhydftax1gmwp4o` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
