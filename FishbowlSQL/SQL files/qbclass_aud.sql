...
--
-- Table structure for table `qbclass_aud`
--

DROP TABLE IF EXISTS `qbclass_aud`;
...
CREATE TABLE `qbclass_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKhck49csgi5egyqhxf875rx4od` (`REV`),
  CONSTRAINT `FKhck49csgi5egyqhxf875rx4od` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
