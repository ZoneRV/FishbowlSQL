...
--
-- Table structure for table `mo_aud`
--

DROP TABLE IF EXISTS `mo_aud`;
...
CREATE TABLE `mo_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKp166bbsgmnfsxpdx7crilasqb` (`REV`),
  CONSTRAINT `FKp166bbsgmnfsxpdx7crilasqb` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
