...
--
-- Table structure for table `watch_aud`
--

DROP TABLE IF EXISTS `watch_aud`;
...
CREATE TABLE `watch_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK27rcb0qt1w4t8din47ew2rbna` (`REV`),
  CONSTRAINT `FK27rcb0qt1w4t8din47ew2rbna` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
