...
--
-- Table structure for table `calcategory`
--
...
CREATE TABLE `calcategory` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK1qdinh0w1ixv3bl6fnc36uqsi` (`name`,`parentID`),
  KEY `calCategoryNameIdx` (`name`),
  KEY `FKoqlx6lyen5qhibm7jpmb75dbh` (`lastChangedUserId`),
  CONSTRAINT `FKoqlx6lyen5qhibm7jpmb75dbh` FOREIGN KEY (`lastChangedUserId`) REFERENCES `sysuser` (`id`)
