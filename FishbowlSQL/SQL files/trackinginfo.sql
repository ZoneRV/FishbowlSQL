...
CREATE TABLE `trackinginfo` (
  ...
  PRIMARY KEY (`id`),
  KEY `trackingInfoInfoIdx` (`info`),
  KEY `trackingInfoInfoDateIdx` (`infoDate`),
  KEY `trackingInfoInfoIntegerIdx` (`infoInteger`),
  KEY `trackingInfoQtyIdx` (`qty`),
  KEY `trackingInfoTableIdIdx` (`tableId`),
  KEY `trackingInfoRecordIdIdx` (`recordId`),
  KEY `FKll0swo2b0c8nd167nwo3739u1` (`partTrackingId`),
  CONSTRAINT `FKll0swo2b0c8nd167nwo3739u1` FOREIGN KEY (`partTrackingId`) REFERENCES `parttracking` (`id`)
