...
--
-- Table structure for table `vendorcostrule_aud`
--

DROP TABLE IF EXISTS `vendorcostrule_aud`;
...
CREATE TABLE `vendorcostrule_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKbo20quuetisuj9fag7tls2m8l` (`REV`),
  CONSTRAINT `FKbo20quuetisuj9fag7tls2m8l` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
