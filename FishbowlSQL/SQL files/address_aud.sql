...
CREATE TABLE `address_aud` (
  ...
  `addressName` varchar(90) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK86bl6eqdcit8obn2jl1xoote8` (`REV`),
  CONSTRAINT `FK86bl6eqdcit8obn2jl1xoote8` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
