...
--
-- Table structure for table `uom_aud`
--

DROP TABLE IF EXISTS `uom_aud`;
...
CREATE TABLE `uom_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKfmxo9kywg2g98k5slr1t3u1cc` (`REV`),
  CONSTRAINT `FKfmxo9kywg2g98k5slr1t3u1cc` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
