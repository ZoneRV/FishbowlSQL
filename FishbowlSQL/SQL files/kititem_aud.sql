...
--
-- Table structure for table `kititem_aud`
--

DROP TABLE IF EXISTS `kititem_aud`;
...
CREATE TABLE `kititem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKgue87tf19wjb4x43w38da343t` (`REV`),
  CONSTRAINT `FKgue87tf19wjb4x43w38da343t` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
