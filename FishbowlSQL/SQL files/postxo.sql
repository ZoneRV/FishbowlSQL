...
--
-- Table structure for table `postxo`
--

DROP TABLE IF EXISTS `postxo`;
...
CREATE TABLE `postxo` (
  ...
  `xoId` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK7msgpk21p8mvtfhfhm12ren5t` (`statusId`),
  KEY `FK6xgehomkkfii78g8c7vhsodc` (`xoId`),
  CONSTRAINT `FK6xgehomkkfii78g8c7vhsodc` FOREIGN KEY (`xoId`) REFERENCES `xo` (`id`),
  CONSTRAINT `FK7msgpk21p8mvtfhfhm12ren5t` FOREIGN KEY (`statusId`) REFERENCES `postorderstatus` (`id`)
