...
--
-- Table structure for table `ship_aud`
--

DROP TABLE IF EXISTS `ship_aud`;
...
CREATE TABLE `ship_aud` (
  ...
  `num` varchar(35) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKafpde4ksy85kli396p8qr5hab` (`REV`),
  CONSTRAINT `FKafpde4ksy85kli396p8qr5hab` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
