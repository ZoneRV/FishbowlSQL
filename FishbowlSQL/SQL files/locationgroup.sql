...
CREATE TABLE `locationgroup` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKavmvxmck7nw8j2kihnbyw9ldx` (`name`),
  KEY `locationGroupNameIdx` (`name`),
  KEY `FKarya0mcflqbxdbxa18jcrtqhl` (`qbClassId`),
  CONSTRAINT `FKarya0mcflqbxdbxa18jcrtqhl` FOREIGN KEY (`qbClassId`) REFERENCES `qbclass` (`id`)
