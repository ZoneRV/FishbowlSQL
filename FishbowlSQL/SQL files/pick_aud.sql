...
--
-- Table structure for table `pick_aud`
--

DROP TABLE IF EXISTS `pick_aud`;
...
CREATE TABLE `pick_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKgrk0c42s6k6bruqg6i92lrlls` (`REV`),
  CONSTRAINT `FKgrk0c42s6k6bruqg6i92lrlls` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
