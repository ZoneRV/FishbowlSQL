...
CREATE TABLE `tablereference` (
  ...
  `tableRefName` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `displayName` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customFieldsFlag` bit(1) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_iv2167d9ugqirfhiig42xocdi` (`tableId`),
  KEY `tableReferenceTableIdIdx` (`tableId`)
