...
CREATE TABLE `tiinventorylog` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK57ndehmofvh6ufqtmivhiq4qn` (`inventoryLogId`),
  KEY `FKla7kr9d4reefs1f6vp9ruegd0` (`partTrackingId`),
  CONSTRAINT `FK57ndehmofvh6ufqtmivhiq4qn` FOREIGN KEY (`inventoryLogId`) REFERENCES `inventorylog` (`id`),
  CONSTRAINT `FKla7kr9d4reefs1f6vp9ruegd0` FOREIGN KEY (`partTrackingId`) REFERENCES `parttracking` (`id`)
