...
--
-- Table structure for table `fobpoint_aud`
--

DROP TABLE IF EXISTS `fobpoint_aud`;
...
CREATE TABLE `fobpoint_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKpw0g9pp0ch1etlnisgg8jn23b` (`REV`),
  CONSTRAINT `FKpw0g9pp0ch1etlnisgg8jn23b` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
