...
--
-- Table structure for table `calevent_aud`
--

DROP TABLE IF EXISTS `calevent_aud`;
...
CREATE TABLE `calevent_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKrdqlm5pqnm2dnqxtkoodin5qm` (`REV`),
  CONSTRAINT `FKrdqlm5pqnm2dnqxtkoodin5qm` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
