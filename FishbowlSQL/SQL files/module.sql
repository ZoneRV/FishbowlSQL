...
CREATE TABLE `module` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKf73dsvaor0f4cycvldyt2idf1` (`name`),
  KEY `FKneqn5aqlat8qiwu1aqwjsy2bj` (`reportId`),
  CONSTRAINT `FKneqn5aqlat8qiwu1aqwjsy2bj` FOREIGN KEY (`reportId`) REFERENCES `report` (`id`)
