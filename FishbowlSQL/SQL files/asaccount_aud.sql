...
--
-- Table structure for table `asaccount_aud`
--

DROP TABLE IF EXISTS `asaccount_aud`;
...
CREATE TABLE `asaccount_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKmlth3ir9yotyhh6pv0ew1wssr` (`REV`),
  CONSTRAINT `FKmlth3ir9yotyhh6pv0ew1wssr` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
