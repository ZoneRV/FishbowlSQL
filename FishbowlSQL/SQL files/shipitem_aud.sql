...
--
-- Table structure for table `shipitem_aud`
--

DROP TABLE IF EXISTS `shipitem_aud`;
...
CREATE TABLE `shipitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKjqfmu2t5leterf5gd1gfp91wa` (`REV`),
  CONSTRAINT `FKjqfmu2t5leterf5gd1gfp91wa` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
