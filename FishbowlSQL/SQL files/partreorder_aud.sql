...
--
-- Table structure for table `partreorder_aud`
--

DROP TABLE IF EXISTS `partreorder_aud`;
...
CREATE TABLE `partreorder_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKgnn397i9py5cj6e51c2wm22wr` (`REV`),
  CONSTRAINT `FKgnn397i9py5cj6e51c2wm22wr` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
