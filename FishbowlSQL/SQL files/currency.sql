...
CREATE TABLE `currency` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKocsst6ixgkhiji9xt1c1sijgu` (`name`),
  KEY `FKq56f0uga0w61ls5ogfs6u2rts` (`lastChangedUserId`),
  CONSTRAINT `FKq56f0uga0w61ls5ogfs6u2rts` FOREIGN KEY (`lastChangedUserId`) REFERENCES `sysuser` (`id`)
