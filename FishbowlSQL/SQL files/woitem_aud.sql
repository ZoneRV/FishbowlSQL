...
--
-- Table structure for table `woitem_aud`
--

DROP TABLE IF EXISTS `woitem_aud`;
...
CREATE TABLE `woitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKn5m3v7ud72q55s2jfl5sp62q` (`REV`),
  CONSTRAINT `FKn5m3v7ud72q55s2jfl5sp62q` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
