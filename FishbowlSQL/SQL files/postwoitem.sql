...
--
-- Table structure for table `postwoitem`
--

DROP TABLE IF EXISTS `postwoitem`;
...
CREATE TABLE `postwoitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKr0v979qg6vwe12j7x5n8xqgn3` (`postWoId`),
  KEY `FKt412nkfxibsfq306q67h3n3t` (`woItemId`),
  CONSTRAINT `FKr0v979qg6vwe12j7x5n8xqgn3` FOREIGN KEY (`postWoId`) REFERENCES `postwo` (`id`),
  CONSTRAINT `FKt412nkfxibsfq306q67h3n3t` FOREIGN KEY (`woItemId`) REFERENCES `woitem` (`id`)
