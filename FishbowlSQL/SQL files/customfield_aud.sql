...
--
-- Table structure for table `customfield_aud`
--

DROP TABLE IF EXISTS `customfield_aud`;
...
CREATE TABLE `customfield_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK5vwfrj4l3lsigyp3idqrht7ck` (`REV`),
  CONSTRAINT `FK5vwfrj4l3lsigyp3idqrht7ck` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
