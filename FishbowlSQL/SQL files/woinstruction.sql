...
--
-- Table structure for table `woinstruction`
--

DROP TABLE IF EXISTS `woinstruction`;
...
CREATE TABLE `woinstruction` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK3rr6741smo696eutwrmo8yhvr` (`bomInstructionItemId`),
  KEY `FK3qrfcxtoit3u8vvgbe7qo4qxl` (`woId`),
  CONSTRAINT `FK3qrfcxtoit3u8vvgbe7qo4qxl` FOREIGN KEY (`woId`) REFERENCES `wo` (`id`),
  CONSTRAINT `FK3rr6741smo696eutwrmo8yhvr` FOREIGN KEY (`bomInstructionItemId`) REFERENCES `bominstructionitem` (`id`)
