...
--
-- Table structure for table `paymentterms_aud`
--

DROP TABLE IF EXISTS `paymentterms_aud`;
...
CREATE TABLE `paymentterms_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKb1favow7864wx8r5obhhfvlgy` (`REV`),
  CONSTRAINT `FKb1favow7864wx8r5obhhfvlgy` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
