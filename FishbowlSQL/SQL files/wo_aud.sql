...
--
-- Table structure for table `wo_aud`
--

DROP TABLE IF EXISTS `wo_aud`;
...
CREATE TABLE `wo_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKf29rxik9qt4sr07les3rj0uaq` (`REV`),
  CONSTRAINT `FKf29rxik9qt4sr07les3rj0uaq` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
