...
CREATE TABLE `paymentterms` (
  ...
  `typeId` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKlyh9l46mnv040vbnj2e507w7k` (`name`),
  KEY `FKq19y3b4pv3s4y8vmbkp9wrl4c` (`typeId`),
  CONSTRAINT `FKq19y3b4pv3s4y8vmbkp9wrl4c` FOREIGN KEY (`typeId`) REFERENCES `paymenttermstype` (`id`)
