...
--
-- Table structure for table `postransaction_aud`
--

DROP TABLE IF EXISTS `postransaction_aud`;
...
CREATE TABLE `postransaction_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKd1ubqoto2p6ty22p74g38cp2v` (`REV`),
  CONSTRAINT `FKd1ubqoto2p6ty22p74g38cp2v` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
