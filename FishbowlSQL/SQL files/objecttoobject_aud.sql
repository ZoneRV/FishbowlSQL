...
--
-- Table structure for table `objecttoobject_aud`
--

DROP TABLE IF EXISTS `objecttoobject_aud`;
...
CREATE TABLE `objecttoobject_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKg44424j32355gvfbh265qvtuq` (`REV`),
  CONSTRAINT `FKg44424j32355gvfbh265qvtuq` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
