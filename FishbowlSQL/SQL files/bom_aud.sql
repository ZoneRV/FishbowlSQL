...
--
-- Table structure for table `bom_aud`
--

DROP TABLE IF EXISTS `bom_aud`;
...
CREATE TABLE `bom_aud` (
  ...
  `revision` varchar(31) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKk00jevyha8ruf8x0v5ugeeobp` (`REV`),
  CONSTRAINT `FKk00jevyha8ruf8x0v5ugeeobp` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
