...
--
-- Table structure for table `xoitem_aud`
--

DROP TABLE IF EXISTS `xoitem_aud`;
...
CREATE TABLE `xoitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKqth4qeqbwb8o24bedm5mo5rm0` (`REV`),
  CONSTRAINT `FKqth4qeqbwb8o24bedm5mo5rm0` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
