...
CREATE TABLE `customlistitem` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK1t728gc098efy0svp4t71hc05` (`name`,`listId`),
  KEY `FKbw1hubkggjohppm25xsemp6wt` (`listId`),
  CONSTRAINT `FKbw1hubkggjohppm25xsemp6wt` FOREIGN KEY (`listId`) REFERENCES `customlist` (`id`)
