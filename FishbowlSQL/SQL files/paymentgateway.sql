...
CREATE TABLE `paymentgateway` (
  ...
  `javaClass` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `login` varchar(2048) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `other` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secret` varchar(2048) COLLATE utf8mb4_unicode_ci NOT NULL,
