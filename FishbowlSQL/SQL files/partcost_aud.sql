...
--
-- Table structure for table `partcost_aud`
--

DROP TABLE IF EXISTS `partcost_aud`;
...
CREATE TABLE `partcost_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKhubwbu9rsjjdiv88j76vvktcg` (`REV`),
  CONSTRAINT `FKhubwbu9rsjjdiv88j76vvktcg` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
