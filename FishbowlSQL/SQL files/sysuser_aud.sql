...
--
-- Table structure for table `sysuser_aud`
--

DROP TABLE IF EXISTS `sysuser_aud`;
...
CREATE TABLE `sysuser_aud` (
  ...
  `userPwd` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK2jyg6lu5v1vqcbweq6txfiapw` (`REV`),
  CONSTRAINT `FK2jyg6lu5v1vqcbweq6txfiapw` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
