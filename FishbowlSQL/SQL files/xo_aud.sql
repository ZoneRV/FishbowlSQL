...
--
-- Table structure for table `xo_aud`
--

DROP TABLE IF EXISTS `xo_aud`;
...
CREATE TABLE `xo_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK2g6wqja568fg2e42pnmk6rux4` (`REV`),
  CONSTRAINT `FK2g6wqja568fg2e42pnmk6rux4` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
