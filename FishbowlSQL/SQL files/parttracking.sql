...
CREATE TABLE `parttracking` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK4hbx44i04nr6eujj263a9d7od` (`name`),
  KEY `FKfba1dj8x87uf5vtgys8qfn3vi` (`typeId`),
  CONSTRAINT `FKfba1dj8x87uf5vtgys8qfn3vi` FOREIGN KEY (`typeId`) REFERENCES `parttrackingtype` (`id`)
