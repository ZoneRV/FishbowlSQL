...
--
-- Table structure for table `trackinginfo_aud`
--

DROP TABLE IF EXISTS `trackinginfo_aud`;
...
CREATE TABLE `trackinginfo_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKbfbvagfpasqssq6syfw7c3y7l` (`REV`),
  CONSTRAINT `FKbfbvagfpasqssq6syfw7c3y7l` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
