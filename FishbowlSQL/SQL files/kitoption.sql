...
CREATE TABLE `kitoption` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK73gtkri1fgjrxrapwq3kyttt1` (`kitItemId`),
  KEY `FKsm4io1laky3kn9sy1c4r6pm4f` (`productId`),
  CONSTRAINT `FK73gtkri1fgjrxrapwq3kyttt1` FOREIGN KEY (`kitItemId`) REFERENCES `kititem` (`id`),
  CONSTRAINT `FKsm4io1laky3kn9sy1c4r6pm4f` FOREIGN KEY (`productId`) REFERENCES `product` (`id`)
