...
--
-- Table structure for table `cartontype_aud`
--

DROP TABLE IF EXISTS `cartontype_aud`;
...
CREATE TABLE `cartontype_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FK1g9a9878mfgwb3586ewxa6pt5` (`REV`),
  CONSTRAINT `FK1g9a9878mfgwb3586ewxa6pt5` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
