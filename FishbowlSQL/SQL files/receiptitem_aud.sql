...
--
-- Table structure for table `receiptitem_aud`
--

DROP TABLE IF EXISTS `receiptitem_aud`;
...
CREATE TABLE `receiptitem_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKyxpalvufmsjq7nmsih8vnpcg` (`REV`),
  CONSTRAINT `FKyxpalvufmsjq7nmsih8vnpcg` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
