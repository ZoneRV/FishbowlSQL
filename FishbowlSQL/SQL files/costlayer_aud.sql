...
--
-- Table structure for table `costlayer_aud`
--

DROP TABLE IF EXISTS `costlayer_aud`;
...
CREATE TABLE `costlayer_aud` (
  ...
  PRIMARY KEY (`id`,`REV`),
  KEY `FKabu1lhpwohw3bvc5vtni2flms` (`REV`),
  CONSTRAINT `FKabu1lhpwohw3bvc5vtni2flms` FOREIGN KEY (`REV`) REFERENCES `revinfo` (`id`)
